...
def run(args: argparse.Namespace, cfg) -> None:
    ...
    viz_cfg = BehaviorVizConfig(
        ...
        out_main=out_dir / "figures" / "main" / "F_behavior.png",
        out_s1=out_dir / "figures" / "supp" / "S1_response_duration_hist.png",
        out_s2=out_dir / "figures" / "supp" / "S2_previous_speech_duration_hist.png",
        out_s3_long=out_dir / "figures" / "supp" / "S3_long_joint.png",
        out_s3_short=out_dir / "figures" / "supp" / "S3_short_joint.png",
        out_s3_fast=out_dir / "figures" / "supp" / "S3_fast_joint.png",
        out_s3_slow=out_dir / "figures" / "supp" / "S3_slow_joint.png",
